# program to find the percentage of flipcoin
import random
...
def flipCoin():
    ...
    tailspercent = 100.0 - headspercent  # 100 - heads = tails %

    print("Heads percent: " + str(headspercent))  # printing the values on screen
    print("Tails percent: " + str(tailspercent))  # converting numbers to programs by str()
